...
def check_code():
    ...
    query = """
        SELECT b.gutscheincode, b.typ, b.status, b.produkt_id,
    ...
    if result and result["typ"] == "alt":
        cursor.execute("""
            SELECT p.produkt_id, p.produktname, p.beschreibung, p.bildpfad, p.einsatzorte
        ...
        # Einsatzorte als Liste formatieren
        for p in produkte:
